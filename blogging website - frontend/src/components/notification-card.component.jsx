                ...
                <div className="w-full">
                    <h1 className="font-medium text-xl text-dark-grey">
                        <span className="lg:inline-block hidden capitalize">{fullname}</span>
                            <Link to={`/user/${username}`} className="mx-1 text-blackunderline">@{username}</Link>
...

            {
                ...
                <div className="ml-20 p-5 bg-grey mt-5 rounded-md">
                    <div className="flex gap-3 mb-3">
                        ...
                        <div>
                            <h1 className="font-medium rexr-xl text-dark-grey">
                                <Link to={`/user/${author_username}`} className="mx-1 text-black underline">@{author_username}</Link>

                                <span className="font-normal"> replied to</span>

                                <Link to={`/user/${author_username}`} className="mx-1 text-black underline">@{username}</Link>
                            </h1>
                        </div>

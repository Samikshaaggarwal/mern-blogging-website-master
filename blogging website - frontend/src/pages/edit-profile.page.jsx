            ...
            <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                ...
                <div className="w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 md:gap-5">
                        ...
                        <div>
                            <InputBox name="email" type="email" value={fullname} placeholder="Email" disable={true} icon="fi-rr-envelope"/>
                        </div>
                    </div>
                    ...
                    <div className="md:grid md:grid-cols-2 gap-x-6">

                        {
                            Object.keys(social_links).map((key,i)=>{
                                ...
                                return <InputBox key={i} name={key} type="text" value={link}
                                placeholder="https://" icon={"fi " + (key != 'website' ? "fi-brands-" + key : "fi-rr-globe")}/>
                            })
                        }

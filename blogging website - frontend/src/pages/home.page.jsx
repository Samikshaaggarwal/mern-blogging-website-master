...
const HomePage=()=>{
    ...
    let categories=["programming","hollywood","film making","social media","cooking","tech","finances","travel","food"]
    ...
    return (
        <AnimationWrapper>
            <section className="h-cover flex justify-center gap-10">
                ...
                <div className="min-w-[40%] lg:min-w-[400px] max-w-min border-1 border-grey pl-8 ppt-3 max-md:hidden">
